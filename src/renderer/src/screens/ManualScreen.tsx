  ...
  return (
    <div className="screen settings-screen manual-screen">
      ...
      <p className="manual-intro">
        Nuance는 화면 위에서 바로 외국어 텍스트를 클릭해 뜻·발음·문맥을 물어볼 수 있는 앱입니다.
      ...
      <section className="settings-section">
        ...
        <p className="desc">
          텍스트를 확보하는 방식은 콘텐츠 종류에 따라 둘 중 하나로 자동 정해집니다:
        </p>
        <p className="desc">
        ...
        <p className="desc">
          ...
          그리고 위 ①이 지원되지 않거나(텍스트 레이어 없는 PDF 등) 실패하는 나머지 모든 창.
        </p>
        <p className="desc">
      ...
      <section className="settings-section">
        <h2>9. 지원 언어</h2>
        <p className="desc">
          지원 범위는 위 "8. 언어 선택"에서 설명한 3단계 기준으로 실제 언어 목록은
          다음과 같습니다.
        </p>
        <p className="desc">
          <strong>1단계(4개)</strong>: 영어, 일본어, 중국어(간체), 중국어(번체).
        </p>
        <p className="desc">
          <strong>2단계-A · 구글 발음/이미지 검색 + 네이버 사전(30개)</strong>: 아랍어,
          체코어, 덴마크어, 독일어, 그리스어, 스페인어, 페르시아어, 핀란드어, 프랑스어,
          히브리어, 힌디어, 크로아티아어, 헝가리어, 이탈리아어, 조지아어, 라오어, 네덜란드어,
          노르웨이어, 폴란드어, 포르투갈어, 루마니아어, 러시아어, 알바니아어, 스웨덴어,
          태국어, 타갈로그어, 터키어, 우크라이나어, 우르두어, 베트남어.
        </p>
        <p className="desc">
          <strong>2단계-B · 구글 발음/이미지 검색만(25개)</strong>: 암하라어, 아제르바이잔어,
          벨라루스어, 불가리아어, 벵골어, 카탈루냐어, 에스토니아어, 바스크어, 구자라트어,
          아르메니아어, 아이슬란드어, 칸나다어, 한국어, 리투아니아어, 라트비아어, 말라얄람어,
          마라티어, 말레이어, 오리야어, 펀자브어, 슬로바키아어, 슬로베니아어, 세르비아어,
          타밀어, 텔루구어.
        </p>
        <p className="desc">
          위 목록에 없는 언어는 3단계입니다 — 화면/자막에서 감지는 될 수 있어도(또는 아예
          감지가 안 될 수도 있음) 클릭 시 "이 언어는 아직 지원하지 않습니다" 안내만 뜹니다.
        </p>
      </section>

      <section className="settings-section">
        <h2>10. LLM · 사전 API 키</h2>
        <p className="desc">

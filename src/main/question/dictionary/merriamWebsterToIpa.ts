...
// 하이픈은 그대로 통과시킨다(SINGLE 에 매핑 없음) — 실측 확인(2026-07-28, "well-to-do"
// → "ˌwel-tə-ˈdü"): MW 는 합성어 성분 경계에도 하이픈을 쓰는데, 지우면 "wɛltəˈdu"처럼
// 세 단어가 구분 없이 붙어버린다. IPA 관례상 합성어를 하이픈 없이 이어 쓰는 것도 흔하지만,
// 원 철자 경계가 살아있는 게 가독성이 낫다고 판단해 일단 유지(음절 구분 기호 "."로
// 바꾸는 안은 나중에 재검토).

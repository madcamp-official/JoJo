...
### 일본어(ja)
1. **Kotobank**(일일사전=원어사전, 스크래핑) — 小学館 デジタル大辞泉 등 138개 정식 사전 통합. 일본어 정의문 품질 최상.
2. **JMdict**(일영사전, EDRDG) — Kotobank가 못 찾은 단어의 커버리지 폴백(21만+ 항목). 번역어 나열이라 뉘앙스는 약하지만 신조어 대응력이 실측으로 매우 강함(2018년 이후 유행어 다수 포함).
...
- **zh-Hant(번체/대만식)**
  1. **萌典**(중중사전=원어사전, 대만 교육부 편찬) — 대만 행정·공공 용어 등 대만식 표준 어휘는 汉典보다 강함(실측: 捷運 등 대만 인프라 용어).

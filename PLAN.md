...
**지원 범위**: 한국어 모어 화자 대상 / Windows·macOS. 언어는 3단계로 나뉜다(2026-07-30 도입,
TODO.md "언어 확장성" 항목에 상세 근거) — **tier1**(영어·일본어·중국어 간체/번체: OCR+LLM
사전+AI 발음+구글+네이버 완전 지원), **tier2**(eld가 감지 가능한 그 외 56개 언어: OCR+AI
발음(IPA)+구글은 되고 LLM 사전은 없음, 그중 네이버 사전 유무로 다시 2-A/2-B로 나뉨),
**tier3**(그 외 전부: 감지만 되거나 아예 안 되며 기능 없음, 클릭 시 미지원 토스트).
